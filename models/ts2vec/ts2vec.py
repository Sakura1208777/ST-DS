...
class TS2Vec:
    """The TS2Vec model used by STDiffusion's Context-FID metric."""
    ...
    def encode(self, data, mask=None, encoding_window=None, casual=False, sliding_length=None,
